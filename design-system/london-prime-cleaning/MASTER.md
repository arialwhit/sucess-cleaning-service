...
**Project:** London Prime Cleaning
**Generated:** 2026-08-22 02:12:24
...
|------|-----|--------------|
| Primary | `#0B3D62` | `--color-primary` |
| Primary dark | `#082C47` | `--color-primary-dark` |
| Accent / CTA | `#1AA179` | `--color-cta` |
| CTA hover | `#158F6B` | `--color-cta-hover` |
| Background | `#FFFFFF` | `--color-background` |
| Surface | `#F5F7FA` | `--color-surface` |
| Text body | `#1F2937` | `--color-text` |
| Text heading | `#111827` | `--color-heading` |

**Color Notes:** Spec override of generated cyan palette. Deep navy `#0B3D62` for trust/professionalism (UK commercial cleaning). Fresh teal `#1AA179` as the single accent/CTA. White + light grey surfaces. Do not use cyan `#ECFEFF` or generic green `#22C55E`.

**Typography override:** Headings = Sora (geometric, professional). Body = Plus Jakarta Sans (legible, not Inter/Open Sans). Loaded via `next/font`.
